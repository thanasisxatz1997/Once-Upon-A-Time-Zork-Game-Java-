...
public class ImageTransparency
{
     ...
     *    destination file.
     */
    public static Image MakeWhiteImageBackgroundTransparent(Image img)
    {
        ...
        BufferedImage buffImg = imageToBufferedImage(img);
        final BufferedImage source = buffImg;

        //final int color = source.getRGB(0, 0);

        final Image imageWithTransparency = makeColorTransparent(source, Color.white);
